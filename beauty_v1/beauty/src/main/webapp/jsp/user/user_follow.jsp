				...
				<div class="team-item col-md-3 match-height nopaddingleftright">
					<div class="hover-effect smoothie match-height">
						<a href="#" class="smoothie"> <img
							src="<%=path%>/<c:out value="${list.profileimg}" />" alt="Image"
						...
						<div class="hover-caption dark-overlay smoothie text-center">
							...
							<div class="vertical-align-bottom">
								<a href="${pageContext.request.contextPath}/center/uploader?uploaderid=<c:out value="${list.id}" />" class="btn btn-primary mb20" target="_blank">进入空间 <i
...
$.ajax({
	url:"${pageContext.request.contextPath}/center/user_follow?followerid="+followerid,
	type:"GET",
	success:function(){
