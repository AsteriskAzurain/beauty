                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		                ...
		                <div class="main-content container-fluid p-0">
		                    <div class="email-head">
		                        <div class="email-head-title">写一篇新的博客<span class="icon mdi mdi-edit"></span></div>
		                    </div>
		                    <form  method="post" action="<%=path %>/back/addblog" enctype="application/json">
		                    	<div class="email-compose-fields">
			                        <div class="subject">
			                            ...
			                            <div class="form-group row pt-2">
			                                ...
			                                <div class="col-8 col-md-8">
			                                    <input name="title" class="form-control" type="text" placeholder="起一个吸引人的标题" required="required">
			                                </div>
		                    	 ...
		                    	 <div class="email editor">
			                        <div class="col-md-12 p-0">
			                            <div class="form-group">
			                                ...
			                                <textarea class="form-control" id="summernote" name="content" rows="6"  required="required"></textarea>
...
<!-- 			                         	<input type="hidden" name="createtime" value="">
			                         	...
			                         	<input type="hidden" name="recFlag" value="">
										...
										<div class="card card-figure col-3">
		                                    <figure class="figure">
		                                        <div class="figure-img">
		                                            <img class="img-fluid" src="<%=path %>/images/card-img.jpg" alt="Card image cap">
		                                        ...
		                                        <figcaption class="figure-caption">
		                                           <input name="pic1" type="text" class="text-muted mb-0"  placeholder="添加图片描述" > 
		                                           <!-- 	<button type="button" class="pull-right figure-title btn btn-outline-light btn-xs btn-rounded mr-1">预览</button> -->
		                                        </figcaption>
		                                    </figure>
		                                </div>
		                                <div class="card card-figure col-3">
		                                    <figure class="figure">
		                                        <div class="figure-img">
		                                            <img name="picUrl2" class="img-fluid" src="<%=path %>/images/card-img.jpg" alt="Card image cap">
		                                            <div class="figure-action">
		                                                <div class="custom-file custom-file-naked">
		                                        ...
		                                        <figcaption class="figure-caption">
		                                            <input name="pic2" type="text" class="text-muted mb-0"  placeholder="添加图片描述" > 
		                                        </figcaption>
		                                    </figure>
		                                </div>
		                                <div class="card card-figure col-3">
		                                    <figure class="figure">
		                                        <div class="figure-img">
		                                            <img  name="picUrl3" class="img-fluid" src="<%=path %>/images/card-img.jpg" alt="Card image cap" id="pic3">
		                                            <div class="figure-action">
		                                                <div class="custom-file custom-file-naked">
		                                        ...
		                                        <figcaption class="figure-caption">
		                                           	<input name="pic3"  type="text" class="text-muted mb-0" placeholder="添加图片描述" > 
		                                        </figcaption>
		                                    </figure>
		                                </div>
		                            </div>
			                        <div class="email action-send">
			                            <div class="col-md-12 ">
			                                <div class="form-group text-right">
			                                    ...
			                                    <button class="btn btn-secondary btn-space" type="button"><i class="icon s7-close"></i> 取消</button>
			                                </div>
			                            </div>
			                        </div>
	...
	<script type="text/javascript">
		$(window).on('load', function(){
			...
			if(cookiestr!=""){
				...
				var userid=cookiestr.split("#")[2];
				username=decodeURIComponent(username)
				$("#writer").val(userid)
				console.info("writerid="+$("#writer").val())
			}	
