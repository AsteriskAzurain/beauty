...
INSERT INTO `blog` VALUES ('21', 'test blog', '21', '1', 'scsdca', '2020-05-09 23:41:11', null, '1', null, 'images/blogimg/u6.png', null, null, null, null, null, '1');
...
INSERT INTO `blog_comment` VALUES ('120', '6', '2', null, 'test cmt 0508 2214', '2020-05-08 22:14:16', '0', '0');
...
INSERT INTO `blog_comment` VALUES ('134', '6', '6', '133', 'test reply 0511 0628', '2020-05-11 06:28:28', '0', '1');
INSERT INTO `blog_comment` VALUES ('135', '6', '21', null, 'test cmt 0512 1644', '2020-05-12 16:44:17', '0', '1');
INSERT INTO `blog_comment` VALUES ('136', '6', '7', null, 'test cmt 0513', '2020-05-13 10:29:54', '0', '1');
INSERT INTO `blog_comment` VALUES ('137', '6', '7', '136', 'test cmt 0514 0546', '2020-05-14 05:46:44', '0', '1');
INSERT INTO `blog_comment` VALUES ('138', '6', '6', '133', 'sada', '2020-05-14 14:13:44', '0', '1');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'c3284d0f94606de1fd2af172aba15bf3', '1', '0', '2020-03-25', 'sbs', 'kkk', 'images/userimg/default.jpg', '1');
...
INSERT INTO `user` VALUES ('54', 'waaaaa', '93279e3308bdbbeed946fc965017f67a', '2', '1', null, null, null, 'images/userimg/default.jpg', '1');
INSERT INTO `user` VALUES ('55', 'abcd', 'bf709005906087dc1256bb4449d8774d', '1', '0', '2020-01-30', '', '', 'images/userimg/default.jpg', '1');
INSERT INTO `user` VALUES ('56', 'newuser', 'a6628f071cbdaf502d009e132d2f0f27', '1', '2', '2020-05-14', '', '', 'images/userimg/default.jpg', '1');
INSERT INTO `user` VALUES ('57', 'user051501', '22d7fe8c185003c98f97e5d6ced420c7', '2', '0', null, '', '', 'images/userimg/default.jpg', '1');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `upblogcmts` AS select `blog`.`userid` AS `upid`,`blog`.`id` AS `blogid`,count(`blog_comment`.`blogid`) AS `cmts` from (`blog` join `blog_comment` on((`blog`.`id` = `blog_comment`.`blogid`))) where ((`blog`.`del_flag` = 1) and (`blog`.`createtime` <= now())) group by `blog`.`id` ;
